    ...
    <>
      ...
      <Card className="overflow-hidden">
        ...
        <div className="flex items-center gap-2 px-3 py-2.5 border-b border-border">
          ...
          {/* Filtrar — popover com estado + agrupar */}
          <Popover>
            <PopoverTrigger asChild>
              <Button size="sm" variant="outline" className="gap-1.5 h-9 shrink-0">
                ...
                {stateFilter !== "all" && (
                  <span className="ml-0.5 text-[10px] font-semibold text-primary bg-primary/10 rounded-full px-1.5 leading-4">1</span>
                )}
              </Button>
            </PopoverTrigger>
        ...
        <div className="grid grid-cols-1 md:grid-cols-[320px_1fr]">
          ...
          <div className={cn("md:border-r border-border flex flex-col", selectedProfile && "hidden md:flex")}>
            {/* Cabeçalho da lista: contagem + chip de filtro ativo + ⚙️ gerenciar */}
