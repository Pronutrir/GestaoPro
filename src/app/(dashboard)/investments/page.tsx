                  ...
                  <tbody>
                    {projectFinancials
                      ...
                      .map(p => {
                        ...
                        return (
                          <tr key={p.id} className="border-b border-border/50 hover:bg-muted/20 cursor-pointer transition-colors" onClick={() => router.push(`/project/${p.id}`)}>
                            <td className="p-3">
                              <div className="flex items-center gap-2">
            ...
            {selectedProjectData && (
              <>
                ...
                <div className="mt-6 space-y-6">
                  ...
                  <Button variant="outline" className="w-full" onClick={() => { setSelectedProject(null); router.push(`/project/${selectedProjectData.project.id}`); }}>
                    Ir para o Projeto
                  </Button>
                </div>
              </>
